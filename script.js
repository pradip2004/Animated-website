...
document.querySelector('.future-section-text button').addEventListener('mouseover',()=>{
...
document.querySelector('.future-section-text button').addEventListener('mouseleave',()=>{
      gsap.to(".future-section video",{
            opacity: 0,
            duration: 1,
            ease: Expo.easeInOut
